...
#define WORK_STACK_SIZE 8096

static eos_tcb_t tcb1;
static eos_tcb_t tcb2;
static eos_tcb_t tcb3;

static int8u_t stack1[WORK_STACK_SIZE];
...
void eos_user_main() {
    eos_create_task(&tcb1, (addr_t)stack1, WORK_STACK_SIZE, sender_task, NULL, 50);
    eos_create_task(&tcb2, (addr_t)stack2, WORK_STACK_SIZE, receiver_task1, NULL, 10);
    eos_create_task(&tcb3, (addr_t)stack3, WORK_STACK_SIZE, receiver_task2, NULL, 10);
